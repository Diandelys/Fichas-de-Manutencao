    ...
    itemsPagina.forEach((registro) => {
      ...
      item.innerHTML = `
					...
					<div class="flex items-center justify-center sm:justify-end space-x-2 pt-2 sm:pt-0 border-t sm:border-t-0 border-[#F3F4F6]">
						...
						<button class="pe-btn pe-btn-secondary pe-btn-sm border border-[#CBD5E1] hover:border-[#94A3B8] text-[#0F0E0D] font-medium py-1 px-3 rounded-md flex items-center justify-center gap-1.5 shadow-2xs edit-btn" data-id="${registro.id}">
